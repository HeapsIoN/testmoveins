...
<title>Company Profile Password Reset - <?php echo $this->page->site['sitename']; ?></title>
</head>
...
<table id="email" cellpadding="0" cellspacing="0" width="800px" border="none">
	<thead>
    	<tr>
        	<td colspan="2">
            	<img src="cid:<?php echo $this->companies->headlogo; ?>" alt="StorMan" width="800" height="150" />
            </td>
		</td>
        <tr>
        	<td colspan="2" class="head">
            	Company Profile Password Reset - <?php echo $this->page->site['sitename']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
			<td colspan="2" class="body">
            	<p>&nbsp;</p>
            	<p>Your password at <?php echo $this->page->site['sitename']; ?> has been reset. The details of your account are as follows:</p>
                <p>&nbsp;</p>
            </td>
        </tr>
        <tr>
            <td class="lbl" style="width:25%;table-layout:fixed">URL</td>
            <td class="inf" style="width:75%;table-layout:fixed"><a href="https://<?php echo $this->page->site['siteurl']; ?>/admin/login" class="link"><?php echo $this->page->site['siteurl']; ?>/admin/login</a></td>
        </tr>
        <tr>
            <td class="lbl" style="width:25%;table-layout:fixed">User</td>
            <td class="inf" style="width:75%;table-layout:fixed"><?php echo $this->page->record['companyemail']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
			<td colspan="2" class="body">
                ...
                <p><img src="cid:<?php echo $this->companies->footlogo; ?>" class="foot-logo" alt="StorMan" width="210" height="60" /></p>
	...
	<tfoot>
    	<tr>
        	<td colspan="2" class="foot">
            	This is a system generated email that was sent via the <?php echo $this->page->site['sitename']; ?> website. This was sent to <a href="mailto:<?php echo $this->page->record['companyemail']; ?>" class="foot"><?php echo $this->page->record['companyemail']; ?></a> as this was the email address that was on file for the facility. If you have received this in error, please immediately delete any and all copies of this email, in part or in whole.
            </td>
        </tr>
    </tfoot>
</table>
