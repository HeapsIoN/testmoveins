...
<form id="profile" class="form-horizontal col-xs-12 pad-none mrg-b-md<?php echo $cls; ?>" data-toggle="validator" role="form">
    <div class="col-xs-12 well">
        ...
        <div class="form-group mrg-b-md business<?php echo $bus; ?>">
            <label for="companynumber" class="col-lg-3 control-label">GST Number</label>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-7 col-lg-offset-3 pad-b-md">
            ...
            <div class="form-col col-lg-2 pad-b-md">
                <input type="text" class="form-control suburb-finder" ac-tag="customer" id="customerpostcode" name="customerpostcode" placeholder="Enter your postcode*" value="<?php $this->moveins->custdata('customerpostcode'); ?>" required filter="max_length:4" data-invalid="You must enter your postcode" res-ph="Enter your postcode*" bus-ph="Enter your postcode*" res-err="You must enter your postcode" bus-err="You must enter the business postcode" />
            </div>
        </div>
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-2 pad-b-md">
                <input type="text" class="form-control suburb-finder" ac-tag="customermail" id="customermailpostcode" name="customermailpostcode" placeholder="Enter your mailing postcode" value="<?php $this->moveins->custdata('customermailpostcode'); ?>" filter="max_length:4" required data-invalid="You must enter your mailing postcode" res-ph="Enter your mailing postcode" bus-ph="Enter the business mailing postcode" res-err="You must enter your mailing postcode" bus-err="You must enter the business mailing postcode" />
            </div>
        </div>
     ...
     <hr class="residential <?php echo $res; ?>" />
        ...
        <h4 class="dual-contact residential<?php echo $res; ?>" alt-txt="Alternate Personal Information" dual-txt="Secondary Personal Information">Alternate Contact Information</h4>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-2 pad-b-md">
                <input type="text" class="form-control dual-contact suburb-finder" ac-tag="customeralt" id="customeraltpostcode" name="customeraltpostcode" alt-txt="Enter the alternate contact postcode<?php echo $req; ?>" dual-txt="Enter the secondary contact postcode<?php echo $req; ?>" filter="max_length:4" placeholder="Enter the alternate contact postcode<?php echo $req; ?>" value="<?php $this->moveins->custdata('customeraltpostcode'); ?>"<?php echo $rat; ?> data-invalid="You must enter the postcode for the secondary contact." res-ph="Enter the alternate contact postcode<?php echo $req; ?>" bus-ph="Enter the business owners postcode*" res-err="You must enter the postcode for the secondary contact" bus-err="You must enter the postcode for the business owner" />
            </div>
        </div>
