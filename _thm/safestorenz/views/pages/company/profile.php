...
<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 pad-none">
	<form id="form" smp-process="company" smp-action="profile">
    ...
    <div class="col-xs-12 pad-none group group-hdn" id="images">
        ...
        <h2 class="col-xs-12">Company Logo</h2>
        <div class="col-xs-12 form-group">
            ...
            <p>You need to save the company before you can upload any images for the company.
        </div>
        ...
        <?php $lc = isset($this->page->record['companylogo']) && $this->page->record['companylogo']!='' ? '' : ' hdn'; ?>
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 form-group company-logo<?php echo $cls; ?>" id="header-row">
            <?php
        ...
        <?php $hc = isset($this->page->record['companyemailheader']) && $this->page->record['companyemailheader']!='' ? '' : ' hdn'; ?>
        ...
        ?>
        <div class="col-xs-12 col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 form-group company-logo<?php echo $cls; ?>" id="footer-row">
            <?php
        ...
        <?php $fc = isset($this->page->record['companyemailfooter']) && $this->page->record['companyemailfooter']!='' ? '' : ' hdn'; ?>
