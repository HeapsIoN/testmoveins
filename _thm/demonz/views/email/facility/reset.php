...
<title>Facility Profile Password Reset - <?php echo $this->page->site['sitename']; ?></title>
</head>
	...
	<thead>
        ...
        <tr>
        	<td colspan="2" class="head">
            	Facility Profile Password Reset - <?php echo $this->page->site['sitename']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
			<td colspan="2" class="body">
            	<p>&nbsp;</p>
            	<p>Your account password at <?php echo $this->page->site['sitename']; ?> has been reset. The details of your account are as follows:</p>
            	<p>&nbsp;</p>
            </td>
        </tr>
        <tr>
            <td class="lbl" style="width:25%;table-layout:fixed">URL</td>
            <td class="inf" style="width:75%;table-layout:fixed"><a href="https://<?php echo $this->page->site['siteurl']; ?>/admin" class="link"><?php echo $this->page->site['siteurl']; ?>/admin</a></td>
        </tr>
        <tr>
            <td class="lbl" style="width:25%;table-layout:fixed">User</td>
            <td class="inf" style="width:75%;table-layout:fixed"><?php echo $this->page->record['facilityemail']; ?></td>
        </tr>
        <tr>
	...
	<tfoot>
    	<tr>
        	<td colspan="2" class="foot">
            	This is a system generated email that was sent via the <?php echo $this->page->site['sitename']; ?> website. This was sent to <a href="mailto:<?php echo $this->page->record['facilityemail']; ?>" class="foot"><?php echo $this->page->record['facilityemail']; ?></a> as this was the email address that was on file for the facility. If you have received this in error, please immediately delete any and all copies of this email, in part or in whole.
            </td>
        </tr>
    </tfoot>
</table>
