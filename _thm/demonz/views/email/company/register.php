...
<title>Company Profile Setup - <?php echo $this->page->site['sitename']; ?></title>
</head>
	...
	<thead>
        ...
        <tr>
        	<td colspan="2" class="head">
            	Company Profile Setup - <?php echo $this->page->site['sitename']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
			<td colspan="2" class="body">
            	<p>&nbsp;</p>
            	<p>A profile has been set up for your company at <?php echo $this->page->site['sitename']; ?>. The details of your profile are as follows:</p>
            	<p>&nbsp;</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="inf" style="width:75%;table-layout:fixed"><?php echo $this->page->postdata['companyemail']; ?></td>
        </tr>
        <tr>
	...
	<tfoot>
    	<tr>
        	<td colspan="2" class="foot">
            	This is a system generated email that was sent via the <?php echo $this->page->site['sitename']; ?> website. This was sent to <a href="mailto:<?php echo $this->page->postdata['companyemail']; ?>" class="foot"><?php echo $this->page->postdata['companyemail']; ?></a> as this was the email address that was on file for the facility. If you have received this in error, please immediately delete any and all copies of this email, in part or in whole.
            </td>
        </tr>
    </tfoot>
</table>
