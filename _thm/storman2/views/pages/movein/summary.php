...
<fieldset>
    ...
    <div class="form-group pad-t-lg mrg-b-none">
        ...
        <div class="col-lg-4">
            ...
            <p>$<?php if(isset($this->moveins->order['unitrate'])){echo number_format($this->moveins->order['unitrate'],2,'.',',');} ?> / month</p>	
        </div>
        <?php
        ...
        <div class="col-lg-4">
            ...
            <p>$<?php echo number_format($this->moveins->order['insurrate'],2,'.',','); ?> / month</p>	
        </div>
        ...
        <div class="col-lg-4">
            ...
            <p>$<?php echo $this->moveins->facinfo['fees']['deposit']; ?></p>	
        </div>
        <?php	
            }
        ?>
    ...
    <div class="form-group mrg-b-none">
        <div class="col-lg-4">
            ...
            <p>$<?php echo number_format($this->moveins->order['total'],2,'.',','); ?> / month</p>	
        </div>
        <div class="col-lg-8">
            <p class="label">Amount Due Today</p>
            <p>$<?php echo number_format($this->moveins->order['duetoday'],2,'.',','); ?> + Processing Fees</p>	
        </div>
        <div class="col-xs-12">
