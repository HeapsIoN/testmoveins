...
<form id="login" class="form-horizontal col-xs-12 col-md-8 mrg-b-md<?php echo $dis; ?>">
    <div class="col-xs-12 well">
        ...
        <div class="col-xs-12 pad-none mrg-b-md">
            <label class="col-xs-12 col-lg-5 control-label" for="customerexistingcode">Email address / customer code</label>
        ...
        <div class="col-xs-12 pad-none mrg-b-md">
            <label class="col-xs-12 col-lg-5 control-label" for="customerexistingpass">Password</label>
            <div class="col-xs-12 col-lg-7">
...
?>
<form id="profile" class="form-horizontal col-xs-12 mrg-b-md<?php echo $cls; ?>" data-toggle="validator" role="form">
    <div class="col-xs-12 well">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 mrg-b-md storman-hdn" id="account-type">
               <label for="isbusiness" class="col-xs-12 col-lg-3 control-label">Customer type</label>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $res; ?>">
            ...
            <div class="form-col col-lg-3 mrg-b-md residential<?php echo $res; ?>">
                <input type="tel" class="form-control res-only" id="customerhomephone" name="customerhomephone" placeholder="Home phone" value="<?php $this->moveins->custdata('customerhomephone'); ?>" filter="phone_au" data-invalid="The home phone is invalid. Try formatting it as +61X XXXX XXXX or entering NA" />
            </div>
            <div class="form-col col-lg-3 mrg-b-md residential business<?php echo $cls; ?>">
     ...
     <hr class="residential <?php echo $res; ?>" />
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-4 mrg-b-md">
                <input type="text" class="form-control dual-contact" id="customeraltlastname" name="customeraltlastname" alt-txt="Enter the alternate contact last name<?php echo $req; ?>" dual-txt="Enter the secondary contact name<?php echo $req; ?>" data-invalid="You must enter the last name for the secondary contact / owner" placeholder="Enter the alternate contact surname<?php echo $req; ?>" value="<?php $this->moveins->custdata('customeraltlastname'); ?>"<?php echo $rat; ?> res-ph="Enter the alternate contact surname<?php echo $req; ?>" bus-ph="Enter the business owners surname*" res-err="You must enter the last name for the secondary contact" bus-err="You must enter the last name for the owner" />
            </div>
        </div>
