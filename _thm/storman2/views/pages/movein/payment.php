...
<input type="hidden" id="cardcode" 		name="cardcode" 		readonly="readonly" value="V" />
<input type="hidden" id="basefee" 		value="" />
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 pad-none">
			...
			if(isset($this->moveins->fees['visa']))
				{
			?>
			<button type="button" class="cc-btn pull-left card-type txt-orange-hover txt-7" id="card-visa" card-fee="<?php echo $this->moveins->basefees['visa']; ?>" card-rate="<?php echo $this->moveins->fees['visa']; ?>" card-code="V"><i class="fa fa-cc-visa txt-mg"></i></button>
			<?php	
				}
			...
			if(isset($this->moveins->fees['mastercard']))
				{
			?>
			<button type="button" class="cc-btn pull-left card-type txt-orange-hover" id="card-mastercard" card-fee="<?php echo $this->moveins->basefees['mastercard']; ?>" card-rate="<?php echo $this->moveins->fees['mastercard']; ?>" card-code="M"><i class="fa fa-cc-mastercard txt-mg"></i></button>
			<?php	
				}
			...
			if(isset($this->moveins->fees['amex']))
				{
			?>
			<button type="button" class="cc-btn pull-left card-type txt-orange-hover" id="card-amex" card-fee="<?php echo $this->moveins->basefees['amex']; ?>" card-rate="<?php echo $this->moveins->fees['amex']; ?>" card-code="A"><i class="fa fa-cc-amex txt-mg"></i></button>
			<?php	
				}
			...
			if(isset($this->moveins->fees['diners']))
				{
			?>
			<button type="button" class="cc-btn pull-left card-type txt-orange-hover" id="card-diners" card-fee="<?php echo $this->moveins->basefees['diners']; ?>" card-rate="<?php echo $this->moveins->fees['diners']; ?>" card-code="D"><i class="fa fa-cc-diners-club txt-mg"></i></button>
			<?php	
				}
