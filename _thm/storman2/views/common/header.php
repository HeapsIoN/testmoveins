...
<header id="header" class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header"><span class="navbar-brand txt-lg"><?php if(isset($this->moveins->facinfo['facilityname'])){echo $this->moveins->facinfo['facilityname'];}else{echo 'StorMan Online Tools';} ?></span> </div>
    <div class="navbar-collapse collapse" id="navbar-main">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="http://www.storman.com/" target="_blank">Storman Online Move-in</a></li>
        
        <?php
		if($this->uri->segment(1)=='admin' && $this->uri->segment(2)!='login')
			{
		?>
        <li><a href="/admin/logout" class="pull-right pad-lr-lg bg-7 bg-4-hover bdr-none" title="Admin Logout"><i class="fa fa-user txt-lg pad-lr-md"></i>Admin Logout</a></li>
        <?php		
			}
        ...
        <div class="col-auto pull-right pad-none<?php echo $cls; ?>" id="account-tools">
            <button type="button" class="col-xs-12 bg-7 bg-4-hover bdr-none lh-60" title="Account Logout" id="account-tgl"><i class="fa fa-user txt-lg pad-lr-md"></i>Account Tools</button>
