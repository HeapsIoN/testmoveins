    ...
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
			<td colspan="2" class="body">
                ...
                <p>Your user name is: <?php echo $this->page->postdata['customeremail']; ?>.</p>
	...
	<tfoot>
    	<tr>
        	<td colspan="2" class="foot">
            	This is a system generated email that was sent via the <?php $this->page->heading('sitename'); ?> website. This was sent to <a href="mailto:<?php echo $this->page->postdata['customeremail']; ?>" class="foot"><?php echo $this->page->postdata['customeremail']; ?></a> as this was the email address that was on file for the customer. A copy was also sent to the facility. If you have received this in error, please immediately delete any and all copies of this email, in part or in whole.
            </td>
        </tr>
    </tfoot>
</table>
