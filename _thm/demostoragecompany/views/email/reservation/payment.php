...
<title>Reservation Payment Processed with <?php echo $this->moveins->facinfo['facilityname']; ?></title>
</head>
...
<table id="email" cellpadding="0" cellspacing="0" width="800px" border="none">
	<thead>
        ...
        <tr>
        	<td colspan="2" class="head">
            	Reservation Payment Processed with <?php echo $this->moveins->facinfo['facilityname']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
            ...
            <p>Thank you for processing an online reservation and payment with <?php echo $this->moveins->facinfo['facilityname']; ?>. The details of your order are as follows:</p>
            <p>&nbsp;</p>
            </td>
        </tr>
        <tr>
