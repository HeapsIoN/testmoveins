...
<header id="header" class="navbar navbar-default navbar-fixed-top">
  <div class="container pad-none">
    ...
    <div class="navbar-collapse pull-right" id="navbar-main">
        ...
        <a href="http://www.storman.com/" target="_blank" class="hidden-xs hidden-sm pull-left pad-lr-lg lh-60 txt-white txt-black-hover">Storman Online <?php if($this->uri->segment(1)=='reservation'){echo 'Reservations';}else{echo 'Move-In';} ?></a>
