...
<div class="form-group mrg-b-md" id="unit-categories">
	...
	?>
		<option value="<?php echo $cat; ?>"<?php echo $sel; ?>><?php echo $category; ?></option>	
	<?php		
		}
	?>
    </select>
...
<div class="form-group mrg-b-md">
	...
	foreach($this->moveins->units as $code => $unit)
		...
		$hdn 	= isset($this->moveins->order['unitcats']) && $this->moveins->order['unitcats']!='' && $this->moveins->order['unitcats']==$uc ? '' : ' hdn';
