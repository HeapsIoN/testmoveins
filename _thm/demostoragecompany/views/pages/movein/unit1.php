<div class="form-group mrg-b-md">
    ...
    <div class="col-lg-10 pad-none mrg-b-md">
        ...
        <div class="col-xs-12 col-md-4 mrg-b-lg unit unit-type">
            <button type="button" class="inl-button col-xs-12 pad-none <?php echo $cls; ?> txt-black bg-3-hover pad-b-md bdr-a-s-1 bdr-mid-grey cur-pnt unit-option" storman-code="<?php echo $code; ?>" storman-rate="<?php echo $unit['unitrate']; ?>" storman-deposit="<?php echo $unit['unitdeposit']; ?>">
                <?php
                if($unit['unitimage']!='')
                    {
                ?>
                ...
                <?php
                if($this->uri->segment(1)!='reservation' || $this->moveins->facinfo['facilityresprices']=='2')
                    {
                ?>
