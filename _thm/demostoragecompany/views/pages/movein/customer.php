...
$this->moveins->order['moveinday'] 		= isset($this->moveins->order['moveinday']) && $this->moveins->order['moveinday']!=''		? $this->moveins->order['moveinday'] 	: date('d');
$this->moveins->order['moveinmonth'] 	= isset($this->moveins->order['moveinmonth']) && $this->moveins->order['moveinmonth']!='' 	? $this->moveins->order['moveinmonth'] 	: date('m');
$this->moveins->order['moveinyear'] 	= isset($this->moveins->order['moveinyear']) && $this->moveins->order['moveinyear']!='' 	? $this->moveins->order['moveinyear'] 	: date('Y');
?>
<form id="profile" class="form-horizontal col-xs-12 pad-none mrg-b-md<?php echo $cls; ?>" data-toggle="validator" role="form">
    <div class="col-xs-12 well">
        ...
        <div class="form-group mrg-b-md mrg-t-md">
        ...
        <legend id="form-title">Storage Agreement Type</legend>
        <div class="form-group">
            ...
            <div class="col-xs-12 mrg-b-md<?php echo $con; ?>">
        ...
        <legend class="residential business<?php echo $cls; ?>">Your Profile</legend>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $res; ?>">
            ...
            <div class="form-col col-lg-3 mrg-b-md residential<?php echo $res; ?>">
                <input type="tel" class="form-control" id="customerhomephone" name="customerhomephone" placeholder="Home phone" value="<?php $this->moveins->custdata('customerhomephone'); ?>" filter="phone_au" data-invalid="The home phone is invalid. Try formatting it as +61X XXXX XXXX or entering NA" />
            </div>
            <div class="form-col col-lg-3 mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-3 mrg-b-md residential business<?php echo $cls; ?>">
                <input type="tel" class="form-control" id="customermobilephone" name="customermobilephone" placeholder="Mobile phone*" value="<?php $this->moveins->custdata('customermobilephone'); ?>" required filter="mobile_au" data-invalid="Mobile number is invalid. Try formatting it as +61 XXX XXX XXX" />
            </div>
        </div>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-5 col-lg-offset-3 pad-b-md">
            ...
            <div class="form-col col-lg-2 pad-b-md">
                <select class="form-control" name="customerstate" id="customerstate" required data-invalid="You must select your state" res-ph="" bus-ph="" res-err="You must select your state" bus-err="You must select the business state">
                    <option value="">[ State ]</option>
                    <?php
                    foreach($this->regioning->states as $v => $l)
                        {
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-2 pad-b-md">
                <select class="form-control" name="customermailstate" id="customermailstate" required data-invalid="You must enter your mailing state" res-ph="" bus-ph="" res-err="You must select your mailing state" bus-err="You must select the business mailing state">
                    <option value="">[ State ]</option>
                    <?php
                    foreach($this->regioning->states as $v => $l)
                        {
     ...
     <hr class="residential <?php echo $res; ?>" />
        ...
        <div class="form-group mrg-b-md residential<?php echo $res; ?>">
            <label for="customerlicenseissued" class="col-lg-3 control-label">Photo ID</label>            
            <div class="form-col col-lg-4 mrg-b-md">
                <select class="form-control res-only" name="customerlicenseissued" id="customerlicenseissued" required data-invalid="You must select the issuer of your license"<?php echo $rds; ?>>
					...
					*/
					$this->moveins->idtypes = !empty($this->moveins->idtypes) ? $this->moveins->idtypes : array('Drivers License' => 'Drivers License', 'Passport' => 'Passport', 'Other' => 'Other');
					
					foreach($this->moveins->idtypes as $v => $l)
                        {
                        $sel = isset($this->moveins->customer['customerlicenseissued'])	&& $this->moveins->customer['customerlicenseissued']==$v ? ' selected="selected"' : '';
            ...
            <div class="form-col col-lg-5 mrg-b-md">
                <input type="text" class="form-control res-only" id="customerlicense" name="customerlicense" placeholder="Enter your Photo ID number*" value="<?php $this->moveins->custdata('customerlicense'); ?>" required filter="max_length:12" data-invalid="You must enter your Photo ID number (max 12 numbers and letters)"<?php echo $rds; ?> />
            </div>
        </div>        
        <div class="form-group mrg-b-md residential<?php echo $res; ?>">
        ...
        <h4 class="dual-contact residential<?php echo $res; ?>" alt-txt="Alternate Personal Information" dual-txt="Secondary Personal Information">Alternate Contact Person</h4>
        <h4 class="business<?php echo $bus; ?>">Business Owner Personal Information</h4>
        <div class="col-xs-12 pad-none"><button type="button" class="btn bg-clear pad-none lh-30 txt-3 txt-7-hover pull-left txt-sm residential business<?php echo $cls; ?>" id="whatsalt">What is this?</button></div>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-3 mrg-b-md">
                <input type="text" class="form-control dual-contact" id="customeraltfirstname" name="customeraltfirstname" alt-txt="Enter the alt. contact first name<?php echo $req; ?>" dual-txt="Enter the secondary contact name<?php echo $req; ?>" data-invalid="You must enter the first name of the secondary contact / owner" placeholder="Enter the alt. contact first name<?php echo $req; ?>" value="<?php $this->moveins->custdata('customeraltfirstname'); ?>"<?php echo $rat; ?> res-ph="Enter the alt. contact first name<?php echo $req; ?>" bus-ph="Enter the business owners first name*" res-err="You must enter the alt. / secondary contact first name" bus-err="You must enter the business owners first name" />
            </div>
            <div class="form-col col-lg-4 mrg-b-md">
                <input type="text" class="form-control dual-contact" id="customeraltlastname" name="customeraltlastname" alt-txt="Enter the alt. contact last name<?php echo $req; ?>" dual-txt="Enter the secondary contact name<?php echo $req; ?>" data-invalid="You must enter the last name for the secondary contact / owner" placeholder="Enter the alt. contact surname<?php echo $req; ?>" value="<?php $this->moveins->custdata('customeraltlastname'); ?>"<?php echo $rat; ?> res-ph="Enter the alt. contact surname<?php echo $req; ?>" bus-ph="Enter the business owners surname*" res-err="You must enter the last name for the secondary contact" bus-err="You must enter the last name for the owner" />
            </div>
        </div>
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-5 col-lg-offset-3 pad-b-md">
                <input type="text" class="form-control dual-contact suburb-finder" ac-tag="customeralt" id="customeraltsuburb" name="customeraltsuburb" alt-txt="Enter the alternate contact suburb / city<?php echo $req; ?>" dual-txt="Enter the secondary contact suburb / city<?php echo $req; ?>" placeholder="Enter the alternate contact suburb / city<?php echo $req; ?>" value="<?php $this->moveins->custdata('customeraltsuburb'); ?>"<?php echo $rat; ?> data-invalid="You must enter the suburb for the secondary contact." res-ph="Enter the secondary contact suburb / city<?php echo $req; ?>" bus-ph="Enter the business owners suburb / city*" res-err="You must enter the suburb for the secondary / alternate contact" bus-err="You must enter the suburb for the business owner" />
            </div>
            <div class="form-col col-lg-2 pad-b-md">
                <select class="form-control" name="customeraltstate" id="customeraltstate" <?php echo $rat; ?> data-invalid="You must select the state for the secondary contact." res-ph="" bus-ph="" res-err="You must select the secondary / alternate contact state" bus-err="You must select the business owners state">
                    <option value="">[ State ]</option>
                    <?php
                    foreach($this->regioning->states as $v => $l)
                        {
