...
<div class="col-lg-12">
     ...
     <hr class="residential <?php echo $res; ?>" />
        ...
        <div class="form-group mrg-b-md residential business<?php echo $cls; ?>">
            ...
            <div class="form-col col-lg-2">
                <select class="form-control" name="customeraltstate" id="customeraltstate" <?php echo $rat; ?> data-invalid="You must select the Suburb / City for the secondary contact." res-ph="" bus-ph="" res-err="You must select the secondary / alternate contact Suburb / City" bus-err="You must select the business owners Suburb / City">
                    <option value="">[ Suburb/City ]</option>
                    <?php
                    foreach($this->regioning->states as $v => $l)
                        {
