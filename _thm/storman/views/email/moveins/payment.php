...
<title>Payment Processed with <?php echo $this->moveins->facinfo['facilityfullname'].' - '.$this->page->site['sitename']; ?></title>
</head>
	...
	<thead>
        ...
        <tr>
        	<td colspan="2" class="head">
            	Payment Processed with <?php echo $this->moveins->facinfo['facilityfullname'].' - '.$this->page->site['sitename']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
		  <td colspan="2" class="body">
              ...
              <p> Thank you for processing an online move-in payment with <?php echo $this->moveins->facinfo['facilityfullname'].' - '.$this->page->site['sitename']; ?>. The details of your order are as follows:</p>
              <p>&nbsp;</p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="lbl" style="width:25%;table-layout:fixed">Amount Paid</td>
