...
<title>Account Created with <?php echo $this->moveins->facinfo['facilityfullname'].' - '.$this->page->site['sitename']; ?></title>
</head>
	...
	<thead>
        ...
        <tr>
        	<td colspan="2" class="head">
            	Account Created with <?php echo $this->moveins->facinfo['facilityfullname'].' - '.$this->page->site['sitename']; ?>
            </td>
        </tr>    
    </thead>
    <tbody cellpadding="5" cellspacing="0">
    	<tr>
			<td colspan="2" class="body">
                ...
                <p>If you forget your password, you can always return to the Move-ins System and request a new password. Thank you for choosing <?php echo $this->moveins->facinfo['facilityfullname']; ?> for your self storage needs.</p>
                <p>Regards,</p>
