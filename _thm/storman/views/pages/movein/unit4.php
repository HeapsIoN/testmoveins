<div class="col-xs-12 pad-none">
    ...
    <div class="col-xs-12 pad-none mrg-b-md" id="unit-sizes">
        <div class="col-xs-12 mrg-t-lg mrg-b-lg">Start by selecting the unit size.</div>
		<?php
	...
	?>
    <div class="col-xs-12 pad-none mrg-b-md<?php echo $cwcls; ?>" id="unit-categories">
        <div class="col-xs-12 mrg-t-lg mrg-b-lg">Thanks for selecting the size, we now need you to select the unit category.</div>
        <?php
        foreach($this->moveins->unitcats as $cat => $category)
			...
			$chdn = isset($this->moveins->order['unitcats']) && $this->moveins->order['unitcats']==$cat ? '' : 'hdn';
        ?>
        <div class="col-xs-12 col-md-4 <?php echo $chdn; ?> unit-category-size unit-size-<?php echo $category['size']; ?>">
    ...
    <div class="col-xs-12 pad-none mrg-b-md" id="unit-types">
        ...
        <div class="col-xs-12<?php echo $mhdn; ?> unit-type-msg mrg-t-lg mrg-b-lg">Great. Now you can select a unit that you would like to rent.</div>
        <?php
