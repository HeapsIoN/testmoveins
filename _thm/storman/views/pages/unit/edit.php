<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 pad-none">
    ...
    <div class="col-xs-12 form-group">
		<?php
		$this->page->fields->text('Unit Name', 'unitwebname', 'unitwebname', 'Enter the company name', 'bdr-3 txt-lg txt-4');
		?>
    </div>
    <div class="col-xs-12 form-group">
		<?php
    ...
    <div class="col-xs-12 form-group<?php echo $cls; ?>">
		...
		?>
        <img src="/_med/units/<?php echo $img; ?>" title="Unit Image" class="col-xs-12 col-sm-4 col-md-3 col-lg-2" alt="" id="unit-image" />
    </div>
    <div class="col-xs-12 form-group<?php echo $cls; ?>">
