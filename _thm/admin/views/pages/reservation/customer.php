...
$url = 	$this->moveins->facinfo['facilityresfee']=='1' 
			? '/reservation/payment' 
		: '/reservation/completed';

?>
<form id="profile" class="form-horizontal col-xs-12 pad-none mrg-b-md" data-toggle="validator" role="form" action="<?php echo $url; ?>">
    <div class="col-xs-12 well">
        ...
        <div class="form-group mrg-b-md">
            ...
            <div class="col-xs-12 col-lg-4 mrg-b-md <?php echo $cls; ?>" id="email-row">
                <input type="email" class="form-control" id="customeremail" name="customeremail" placeholder="Enter your email address*" value="<?php $this->moveins->custdata('customeremail'); ?>" required filter="email" data-invalid="The email address appears to be invalid" <?php if(isset($this->moveins->customer['customercode']) && $this->moveins->customer['customercode']!=''){echo 'readonly';} ?> />
            </div>
            <?php
			if(!isset($this->moveins->customer['customercode']) || $this->moveins->customer['customercode']=='')
				{
        ...
        <div class="col-xs-12 pad-none residential business<?php echo $cls; ?>">
            <button type="button" class="btn pull-right bg-3 bg-4-hover txt-1 txt-1-hover txt-uc save-customer" id="saveprofile">Reserve Space &raquo;</button>
        </div>
    </div>
</form>
