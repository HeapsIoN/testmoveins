...
<input type="hidden" name="vtLoginUsername" value="">
...
<input type="hidden" name="vtReference" value="<?php if(isset($this->moveins->order['reservation'])){echo $this->moveins->order['reservation'];} ?>">
