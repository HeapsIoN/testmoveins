<nav class="col-sm-3 col-md-2 bg-4 pad-none" id="left-nav">
<?php
...
if(!empty($links))
	...
	?>
    <a href="/admin/<?php echo $url; ?>" class="col-xs-12 lh-50 <?php echo $c; ?> bg-5-hover txt-1-hover"><?php echo $inf['lbl']; ?></a>
    <?php		
		}
	}
